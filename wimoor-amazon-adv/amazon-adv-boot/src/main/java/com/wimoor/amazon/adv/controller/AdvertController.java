...
import com.wimoor.amazon.adv.controller.pojo.dto.BindCode;
...
public class AdvertController extends ERPBaseController<AmzAdvAuth> {
	...
	@PostMapping(value = "/bindAdvAuthData")
	public Result<String> bindAdvAuthDataAction(@RequestBody BindCode dto)  {
		String code=dto.getCode();
		String state=dto.getState();
		if (StringUtil.isEmpty(code)) {
			 return Result.success("绑定请求---------无法获取到对应Code");
		}
		try {
