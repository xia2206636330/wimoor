...
IAmzFinAccountService iAmzFinAccountService;
	public void getGroupIdData() throws ApiException, InterruptedException, LWAException {
		   ...
		   for( AmazonAuthority amazonAuthority:list) {
			   List<AmzFinAccount> finlist = iAmzFinAccountService.lambdaQuery().eq(AmzFinAccount::getAmazonAuthid, amazonAuthority.getId())
			                                      .eq(AmzFinAccount::getProcessingStatus,"Open")
			                                      .isNotNull(AmzFinAccount::getNexttoken).list();
	...
	public void getGroupIdData(AmazonAuthority amazonAuthority,AmzFinAccount item) throws ApiException, InterruptedException, LWAException {
	   ...
	   ExecutorService executorService = Executors.newSingleThreadExecutor();
	    ...
	    public void listFinancialEventsByGroupId(AmazonAuthority amazonAuthority,AmzFinAccount fin,String nextToken) throws ApiException, InterruptedException, LWAException {
	    	  FinancesApi api = apiBuildService.getFinancesApi(amazonAuthority);
	          ListFinancialEventsResponse response = api.listFinancialEventsByGroupId(fin.getGroupid(), 100,null,null,nextToken);
