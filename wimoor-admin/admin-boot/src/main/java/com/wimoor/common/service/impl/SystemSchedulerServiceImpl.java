...
public class SystemSchedulerServiceImpl implements SystemSchedulerService {
   ...
   public void insertTask(){
    ...
    public List<QuartzTask> getTaskList() {
        return quartzTaskMapper.selectList(null);
    }

    @Override
    public void disableApi(QuartzTask task) {
        QuartzTask entity = quartzTaskMapper.selectById(task.getId());
        if(entity!=null){
            entity.setIsdelete(true);
            quartzTaskMapper.updateById(entity);
        }
    }

    @Override
    public void enableApi(QuartzTask task) {
        QuartzTask entity = quartzTaskMapper.selectById(task.getId());
        if(entity!=null){
